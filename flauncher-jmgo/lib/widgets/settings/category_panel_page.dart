                          ...
                          DropdownButton<CategorySort>(
                            ...
                            items: [
                              DropdownMenuItem(
                                ...
                                child: Text("По алфавиту", style: Theme.of(context).textTheme.bodySmall),
                              ),
                              DropdownMenuItem(
                                value: CategorySort.manual,
                                child: Text("Вручную", style: Theme.of(context).textTheme.bodySmall),
                              ),
                            ],
                          ),
                        ],
                          ...
                          DropdownButton<CategoryType>(
                            ...
                            items: [
                              DropdownMenuItem(
                                ...
                                child: Text("Строка", style: Theme.of(context).textTheme.bodySmall),
                              ),
                              DropdownMenuItem(
                                value: CategoryType.grid,
                                child: Text("Сетка", style: Theme.of(context).textTheme.bodySmall),
                              ),
                            ],
                          ),
                        ],
