...
import org.futo.voiceinput.JmgoVoiceSignal
...
val ENABLE_MULTILINGUAL = SettingsKey(
    booleanPreferencesKey("enable_multilingual"),
    JmgoVoiceSignal.DEFAULT_MULTILINGUAL
)
...
val MULTILINGUAL_MODEL_INDEX = SettingsKey(
    intPreferencesKey("multilingual_model_index"),
    JmgoVoiceSignal.DEFAULT_MULTILINGUAL_MODEL_INDEX
)

val LANGUAGE_TOGGLES = SettingsKey(
    stringSetPreferencesKey("enabled_languages"),
    setOf(JmgoVoiceSignal.DEFAULT_LANGUAGE)
)
...
val BEAM_SEARCH = SettingsKey(
    key = booleanPreferencesKey("use_beam_search"),
    default = JmgoVoiceSignal.DEFAULT_BEAM_SEARCH
)
