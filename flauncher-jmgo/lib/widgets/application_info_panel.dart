            ...
            TextButton(
              child: Row(
                children: [
                  ...
                  Container(width: 8),
                  Text("Открыть", style: Theme.of(context).textTheme.bodyMedium),
                ],
              ),
              onPressed: () async {
              ...
              TextButton(
                child: Row(
                  children: [
                    ...
                    Container(width: 8),
                    Text("Порядок", style: Theme.of(context).textTheme.bodyMedium),
                  ],
                ),
            ...
            TextButton(
              child: Row(
                children: [
                  ...
                  Container(width: 8),
                  Text(application.hidden ? "Показать" : "Скрыть", style: Theme.of(context).textTheme.bodyMedium),
                ],
              ),
              onPressed: () async {
            ...
            TextButton(
              child: Row(
                children: [
                  ...
                  Container(width: 8),
                  Text("О приложении", style: Theme.of(context).textTheme.bodyMedium),
                ],
              ),
