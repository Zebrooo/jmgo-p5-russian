...
class WallpaperPanelPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
        children: [
          Text("Обои", style: Theme.of(context).textTheme.titleLarge),
          Divider(),
          ...
          TextButton(
            ...
            child: Row(
              children: [
                Icon(Icons.gradient),
                Container(width: 8),
                Text("Градиент", style: Theme.of(context).textTheme.bodyMedium),
              ],
            ),
          ...
          TextButton(
            child: Row(
              children: [
                ...
                Container(width: 8),
                Text("Своё изображение", style: Theme.of(context).textTheme.bodyMedium),
              ],
            ),
            onPressed: () async {
              try {
                  ...
                  SnackBar(
                    ...
                    content: Row(
                      children: [
                        ...
                        SizedBox(width: 8),
                        Text("Установите файловый менеджер, чтобы выбрать изображение.")
                      ],
                    ),
                  ),
                );
            ...
            builder: (context, json, _) {
              if (json != null) {
                ...
                return TextButton(
                  ...
                  child: Text(
                    "Фото: ${authorInfo["username"]}, Unsplash",
