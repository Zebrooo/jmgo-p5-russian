        ...
        child: Column(
          children: [
            ...
            Material(
              ...
              child: TabBar(
                tabs: [
                  Tab(child: Row(children: [Icon(Icons.sync), SizedBox(width: 8), Text("Случайные")])),
                  Tab(child: Row(children: [Icon(Icons.search), SizedBox(width: 8), Text("Поиск")])),
                ],
              ),
            ),
            SizedBox(height: 8),
...
class _RandomTabState extends State<_RandomTab> {
  ...
  Widget build(BuildContext context) => GridView.count(
          ...
          crossAxisSpacing: 8,
          children: [
            _randomCard("Пейзаж", "landscape", AssetImage("assets/landscape.png"), autofocus: true),
            _randomCard("Абстракция", "abstract", AssetImage("assets/abstract.png")),
            _randomCard("Минимализм", "minimal", AssetImage("assets/minimal.png")),
            _randomCard("Текстура", "texture", AssetImage("assets/texture.png")),
            _randomCard("Архитектура", "architecture", AssetImage("assets/architecture.png")),
            _randomCard("Растения", "plant", AssetImage("assets/plant.png")),
            _randomCard("Технологии", "technology", AssetImage("assets/technology.png")),
            _randomCard("Животные", "animal", AssetImage("assets/animal.png")),
            _randomCard("Яркое", "colorful", AssetImage("assets/colorful.png")),
            _randomCard("Космос", "space", AssetImage("assets/space.png")),
          ]);

  Widget _randomCard(String text, String searchTerm, AssetImage assetImage, {bool autofocus = false}) => Focus(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    if (enabled) {
                      ...
                      try {
                        await context.read<WallpaperService>().randomFromUnsplash("$searchTerm wallpaper");
                      } finally {
          ...
          Padding(
            ...
            child: FocusKeyboardListener(
              ...
              builder: (context) => TextField(
                decoration: InputDecoration(labelText: "Поиск", isDense: true),
